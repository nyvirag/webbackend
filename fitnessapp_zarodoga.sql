...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Feb 19. 12:19
...
--
CREATE DATABASE IF NOT EXISTS `fitnessapp_zarodoga` DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
USE `fitnessapp_zarodoga`;
...
INSERT INTO `blog` (`blog_id`, `blog_uzenet`, `blog_datum`) VALUES
(3, 'Lesznek akik lebeszélnek, mert valójában legbelül nem esne nekik jól ha neked sikerülne.', '2024-02-10');
...
(17, 'Guggolás rúddal', 19, 'Állj a súlyzóval vagy rúddal a vállaid mögött vagy a vállaid előtt, tarts a vállszélességűnél kissé szélesebb fogást.\r\nÁllj a lábak széles terpeszben, a lábfejeid kissé kifelé fordítva. Tarts egyenes hátat és erősítsd meg a hasizmokat. Lassan hajlítsd meg a térdeidet és ügyelj arra, hogy a súly közvetlenül lefelé mozogjon. Menj le addig, amíg a combod legalább párhuzamos nem lesz a padlóval. Lassan nyomd fel magad a lábak erejével a kiindulási pozícióba.', 'guggolasruddal.gif'),
(18, 'Román felhúzás', 19, ' Állj a súlyzóval vagy rúddal a kezedben, tarts a vállszélességűnél kissé szélesebb fogást. Tarts egyenes háttal és enyhén hajlítsd meg a térdedet. Húzd fel a súlyt a tested közelében, közben az alsó háti izmaidat összeszorítva és a hátadat egyenesen tartva. Lassan engedd le a súlyt a combjaidra úgy, hogy közben kontrolláltan mozgatod a testedet. Ismételd a mozgást a megfelelő számú ismétléssel és a megfelelő súllyal.', 'romanfelhuzas.gif\r\n'),
(19, 'Lábtolás', 19, 'Ülj le a lábtoló gépre úgy, hogy a hátad illeszkedjen a támlához és a lábad a párnára helyezd. Állítsd be a súlyokat vagy a terhelést a gépen az edzéshez szükséges szintre. Tartsd megfelelő testtartást, egyenes háttal és fogd meg a markolatot. Nyomd ki a lábat a gép párnájával vagy súlyával szemben, miközben a lábizmaidat használod. Lassan hajlítsd be a lábad a kiindulási pozícióba kontrollált mozgással.', 'labtolo.gif'),
(20, 'Ülő vádliemelés', 19, 'Ülj le a vádliemelő gépre, a lábaid alatt a vádlid egy párnán vagy a kinyújtható platformon. Helyezd a térded vagy lábszárad a gép támaszára és fogd meg a markolatot vagy a támaszt a kezeddel. Emeld fel a súlyt a vádlid segítségével, miközben a lábizmaidat használod. Fokozatosan engedd le a súlyt a kiindulási pozícióba, majd ismételd a mozgást.', 'ulovadli.gif'),
(21, 'Ülő combfeszítő', 19, 'Ülj le a lábhajlító gépre úgy, hogy a lábad a párnára helyezkedjen és a bokádat a megfelelő rögzítőpárnával rögzítsd. Állítsd be a gépet a kívánt terhelésre vagy súlyra az edzéshez szükséges szinten. Tartsd megfelelő testtartást, és fogd meg a markolatot vagy a támaszt a gépen. Hajlítsd be a lábfejed a combjaid felé, miközben koncentrálsz a combhajlító izmokra. Lassan engedd vissza a lábad a kiindulási pozícióba kontrolláltan.', 'ulocombfeszito.gif\r\n'),
...
(26, 'Plank', 21, 'Kezdd a gyakorlatot úgy, hogy az alkarjaid és a lábfejeid érintik a padlót, közben pedig emeld a tested egyenes vonalban. Az alkarjaid a vállak alatt legyenek, a könyökök pontosan a vállak alatt, és a tenyeredet szorítsd össze. Tarts egyenes vonalat a hátadon, ne hagyd, hogy a medence emelkedjen vagy süllyedjen. A fejed legyen egyenesen a gerinceddel, a nyakad és a fejed is egyenes vonalban a hátaddal. Tartsd ezt a pozíciót, miközben feszíted a törzsizmaidat.', 'plank.gif'),
(27, 'Hasprés', 21, 'Feküdj hanyatt a padlón vagy egy szőnyegen, hajlítsd meg a térdeidet, és tedd a lábfejeidet laposan a talajra. Tegyél kezedet a fejed mögé vagy keresztbe a mellkasod előtt. Emeld fel a felsőtested a padlóról, miközben a hasizmaidat használod, és a vállaid csak a lapátcsontjaidig emelkednek fel. Fokozatosan ereszd le a felsőtestedet a kiindulási pozícióba, majd ismételd a mozgást.', 'haspres.gif'),
...
(34, 'Fekvenyomás szűk fogással', 22, 'Feküdj le a padra úgy, hogy a fejed a szűkebb fogást (vállszélességűnél szűkebb) tartó rudat vagy súlyzót érintse. Tartsd a karjaidat egyenesen, majd emeld ki a rudat a tartóról, és zárd össze a kezed. Engedd le a súlyt a mellkasodhoz úgy, hogy a könyökök szorosan maradjanak a tested mellett. Nyomd vissza a súlyt a kiindulási pozícióba a karjaidat kiegyenesítve.', 'szukfekvenyomas.gif'),
...
(48, 'Széles lehúzás', 27, 'Állj a lehúzó gép elé, fogd meg a rudat szélesen, a kezeket vállszélesség felett.\r\nHajlítsd meg a könyököd, húzd le a rudat a mellkasodhoz. Tartsd meg a pozíciót egy rövid ideig, majd lassan emeld vissza a rudat. Koncentrálj a felső hátsó izmaidra, és tartsd a tested stabilan.', 'szeleslehuzas.gif');
...
--
ALTER TABLE `csevego`
  MODIFY `csevego_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
